...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText = new FlxText(900, 650, 0, "SCORE: 49324858", 36);
		scoreText.setFormat("VCR OSD Mono", 32, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		for (i in 0...WeekData.weeksList.length)
		{
			...
			var weekThing:MenuItem = new MenuItem(0, bgSprite.y + 396, WeekData.weeksList[0]);
			weekThing.y += -170;
			weekThing.targetY = 0;
