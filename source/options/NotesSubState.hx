...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		grid3 = new FlxBackdrop(Paths.image('fpstuff/grid3'), 5, 5, true, true);
		grid3.antialiasing = ClientPrefs.globalAntialiasing;
		add(grid3);
	...
	override function update(elapsed:Float) {
		...
		super.update(elapsed);
		grid3.x = FlxMath.lerp(grid3.x, grid3.x + 10, CoolUtil.boundTo(elapsed * 9, 0, 1));
		grid3.y = FlxMath.lerp(grid3.y, grid3.y - 10, CoolUtil.boundTo(elapsed * 9, 0, 1));
	}
